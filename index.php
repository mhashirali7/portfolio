                    ...
                    <div class="px-5 py-8 bg-white dark:bg-nightBlack rounded-2xl hero-section md:p-8 lg:p-10 2xl:p-13">
                        ...
                        <div class="items-center gap-6 hero-content md:flex xl:gap-10">
                            <div class="text-content pt-7 lg:pt-8 max-lg:max-w-[30rem]">
                                ...
                                <p>
                                    I am a <span class="font-medium text-black dark:text-white/90">Full-Stack Developer</span> at heart and, i create features that are best suited for the job at hand.
                                </p>
                    ...
                    <div class="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl about-section lg:p-10 2xl:p-13">
                        ...
                        <div class="mt-7 md:mt-10 section-title">
                            ...
                            <p class="max-w-2xl mt-4 md:mt-6 subtitle">
                                Hi, my name is <span class="text-black dark:text-white">Muhammad Hashir Ali</span> and I began using WordPress when first began. spent most of my waking hours for the last ten years designing, programming and operating <span class="text-black dark:text-white"> WordPress</span> sites go beyond with exclusive designer.
                            </p>
                        </div>
                        <div class="mt-6 section-content">
                            ...
                            <ul class="grid mt-4 mb-10 text-sm lg:mt-6 md:grid-cols-2 gap-x-8 gap-y-3">
                                <li class="flex items-center">
                                    ...
                                    <span class="text-black dark:text-white">+(92) 316 6635 774 </span>
                                </li>
                                <li class="flex items-center">
                                    <span class="flex-[0_0_6rem]">Email</span>
                                    <span class="flex-[0_0_2rem]">:</span>
                                    <span class="text-black dark:text-white">muhammad.hashir.ali.official@gmail.com</span>
                                </li>
                                <li class="flex items-center">
                                ...
                                <li class="flex items-center">
                                    ...
                                    <span class="flex-[0_0_2rem]">:</span>
                                    <span class="text-black dark:text-white">github.com/MHashirAli</span>
                                </li>
                                <li class="flex items-center">
                                    <span class="flex-[0_0_6rem]">Language</span>
                                    <span class="flex-[0_0_2rem]">:</span>
                                    <span class="text-black dark:text-white">Urdu, English</span>
                                </li>
                            </ul>
                ...
                <div data-scroll-index="2" id="service"
                    ...
                    <div class="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
                        ...
                        <div class="grid gap-5 md:gap-6 service-card-wrapper sm:grid-cols-2 lg:gap-7 2xl:gap-8">
                            <div class="relative p-5 transition duration-300 border py-7 md:p-7 card-item group border-platinum dark:border-metalBlack rounded-2xl xl:p-8 2xl:p-10 hover:border-theme">
                                <div
                            ...
                            <ul
                                ...
                                <li
                                    ...
                                    <div
                                        ...
                                        <h4
                                            class="text-xl xl:text-2xl font-medium xl:font-medium leading-7 text-black dark:text-white mb-2.5">
                                            Intermediate/Diploma in Computer Information Technology
                                        </h4>
                                        <p>
                                            Owing to advancements in product other designer technologies aute voluptate.
                                        </p>
                    ...
                    <div class="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
                        ...
                        <div class="portfolio_wrapper grid sm:grid-cols-2 gap-4 lg:gap-7.5">
                            <div class="relative item md:col-span-2 z-1 group">
                                <a class='flex items-center justify-center p-3 overflow-hidden border md:p-4 rounded-xl border-platinum dark:border-greyBlack' href='project-single.html'>
                ...
                <div data-scroll-index="8" id="contact"
                    ...
                    <div class="px-5 py-8 bg-white dark:bg-nightBlack rounded-2xl contact-section lg:p-13">
                        ...
                        <iframe
                            ...
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115720.10344071065!2d66.91659451271583!3d24.991509811100077!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb3411d1b1aa5dd%3A0x7f8008a575c0b797!2sNew%20Karachi%20Town%2C%20Karachi%2C%20Karachi%20City%2C%20Sindh%2C%20Pakistan!5e0!3m2!1sen!2s!4v1709157557347!5m2!1sen!2s"

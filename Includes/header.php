...
<body class="relative custom_cursor">
    ...
    <div id="preloader">
        ...
        <div
            ...
            <img src="assets/img/logo.png" alt="Minfo">
        </div>
    </div>
    <!-- App Preloader End -->
        ...
        <div class="max-lg:px-4">
            ...
            <div
                ...
                <div class="text-lg font-medium name">
                    <a class='flex items-center gap-2 text-black dark:text-white' href='index.php'>
                        <img src="assets/img/logo.png" alt="Minfo">
                        <span>Minfo</span>
                    </a>
                </div>
            ...
            <div class="w-full mx-auto minfo__sidebar__wrapper xl:fixed xl:top-1/2 xl:left-4 2xl:left-14 xl:-translate-y-1/2 md:max-w-sidebar xl:max-2xl:max-w-xs z-999">
                ...
                <div class="p-3 mb-3 overflow-hidden minfo__sidebar bg-white dark:bg-nightBlack rounded-2xl">
                    <div class="mx-4 mt-12 text-center user-info lg:mx-6">
                        <a class='w-36 h-36 mb-2.5 block mx-auto border-6 border-platinum dark:border-[#2f2f2f] overflow-hidden rounded-full' href='index.php'>
                            <img 
                        ...
                        <div class="leading-none cd-headline clip is-full-width">
                            <h6 class="text-sm cd-words-wrapper designation text-theme after:!bg-theme">
                                ...
                                <b class="font-normal">3D Architecture Designer</b>
                                <b class="font-normal">Degital Marketer</b>
                            </h6>
                        </div>
                    </div>
                    ...
                    <div class="px-4 py-5 lg:py-6 lg:px-6 rounded-2xl md:px-8 bg-flashWhite dark:bg-metalBlack">
                        ...
                        <div class="flex items-center justify-between my-4 space-x-4 skills_circle">
                            ...
                            <div class="space-y-2 text-center progressCircle">
                                <div class="relative w-12 h-12 circle" data-percent="75">
                                    <div class="absolute inset-0 text-[13px] font-medium label flex-center">75%</div>
                                </div>
                                <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/90">3Ds Max</p>
                            </div>
                            <div class="space-y-2 text-center progressCircle">
                                ...
                                <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/90">Java</p>
                            </div>
                        </div>
                        <div class="mt-6">
